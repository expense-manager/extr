...
public class IconPickerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private static final String TAG= IconPickerAdapter.class.getSimpleName();
    ...
    private IconPickerFragment.IconPickerListener listener;
    private IconPickerFragment fragment;

    public IconPickerAdapter(Context context, IconPickerFragment.IconPickerListener listener,
                             IconPickerFragment fragment, String currentColor, List<String> colors, Set<String> usedColors) {
